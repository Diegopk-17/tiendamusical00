...
public class HomeController {
	...
	/**
	 * Se inyecta el objeto de Srping con JSF para obtener los metodos de logica de negocio del home.
	 */
	...
	/**
	 * Metodo que permite obtener los albums de los artistas encontrados en la base de datos con
	 * respecto al filtro ingresado por el cliente.
	 */
