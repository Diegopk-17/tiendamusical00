...
/**
 * @author Diego
 *	Interface que define los metodos de logica de negocio para la pantalla de home.
 */
public interface HomeService {

	/**
	 * Metodo que permite consultar los albums con base al filtro que ingrese el cliente en el 
	 * buscador de su home.
